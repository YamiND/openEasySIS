function formhash(form, oldPassword, newPassword, repeatPassword) 
{
    ...
    oldPass.type = "hidden";
    oldPass.value = hex_sha512(oldPassword.value);
    ...
    newPass.type = "hidden";
    newPass.value = hex_sha512(newPassword.value);
    ...
    rPass.name = "rPass";
    rPass.type = "hidden";
    rPass.value = hex_sha512(repeatPassword.value);

    repeatPassword.value = "";

//    if (newPass.value == rPass.value)
 //   { 
