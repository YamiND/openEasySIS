...
function checkPermissions($mysqli)
{
    ...
    {
        viewGenerateManualReportCardForm($mysqli);
    }
    else
    {
...
function viewGenerateManualReportCardForm($mysqli)
{
	echo '
            <div class="row">
                <div class="col-lg-6">
...
echo '
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#generateTranscript" data-toggle="tab">Generate Report Card</a>
                                </li>
                            </ul>
...
function generateManualForm($mysqli)
{
    ...
    generateFormStart("../includes/schoolAdminFunctions/generateManualReportCard", "post", "multipart/form-data"); 
		generateFormHiddenInput("academicYear", $academicYear);
echo <<<EOF
...
EOF;
        ...
        generateFormButton(NULL, "Generate Manual Report Card");
	    ...
	    echo "<a href=\"https://support.office.com/en-us/article/Import-or-export-text-txt-or-csv-files-5250ac4c-663c-47ce-937b-339e391393ba\">To learn how to export a file from Excel as a CSV, please click here</a>";
	   	echo "
		<br>
		<h5>The format for the Manual Report Card CSV should be this: </h5>
