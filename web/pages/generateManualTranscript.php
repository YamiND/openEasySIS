...
echo displaySite("Generate Transcript Manually", "../includes/schoolAdminFunctions/viewGenerateManualTranscriptForm.php", "checkPermissions", "Generate Transcript Manually");
